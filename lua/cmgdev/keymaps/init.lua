...
vim.keymap.set("n", "<C-h>", ":wincmd h<CR>", { silent = true, noremap = true, desc = "[CMGDEV] Go to the left split window" })
vim.keymap.set("n", "<C-j>", ":wincmd j<CR>", { silent = true, noremap = true, desc = "[CMGDEV] Go to the right split window" })
vim.keymap.set("n", "<C-k>", ":wincmd k<CR>", { silent = true, noremap = true, desc = "[CMGDEV] Go to the upper split window" })
vim.keymap.set("n", "<C-l>", ":wincmd l<CR>", { silent = true, noremap = true, desc = "[CMGDEV] Go to the down slpit window" })
